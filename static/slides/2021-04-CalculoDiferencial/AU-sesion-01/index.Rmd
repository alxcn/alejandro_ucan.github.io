...
> Los dos anteriores son parte de los números racionales.
...
.pull-left[Se denotan por:
<br/> <br/> 
<span style="font-size:40px"> $$\mathbb{Q}^c$$
]
...
### Checa las propiedades de los números reales y descifra en que conjunto se encuentra.
