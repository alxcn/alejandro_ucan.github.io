...
2. Dibuja la región $E$ y calcula la integral de $f(x,y,z)=6.$ La región $E$ es la región acotada bajo el plano $z=1+x+y$ y $z=0$ acotadas por las curvas $y=\sqrt{x},\, y=0$ y $x=1.$

3. Dibuja la región $E$ y calcula la integral de $f(x,y,z)=xy.$ La región $E$ es la región acotada por los cilindros parabólicos $z=1-y^2$ y $x=y^2$ y los planos $z=0$ y $z=x+y.$
