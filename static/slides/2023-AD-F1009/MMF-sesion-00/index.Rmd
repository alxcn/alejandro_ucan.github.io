...
---
# Parametrización de Curvas-Superficies
...
#### Ejemplo de parametrizaciones de Curvas:

* La parametrización de una hélice es $$h(t)=(\cos(t),\sin(t),t)$$ con $t\in\mathbb{R}.$ <br/><br/>
* La parametrización de un segmento de recta entre $p$ y $q$ es $$s(t)=p+t(q-p)$$ con $t\in[0,1].$ <br/><br/>
* La parametrización de un cardiode es $$c(t)=(2\cos(t)-\cos(2t),2\sin(t)-\sin(2t))$$ con $t\in[0,2\pi].$ <br/><br/>

----
#### Ejemplo de parametrizaciones de Superficies:

* La parametrización de un helicoide es $$h(u,v)=(u\cos(v),u\sin(v),v)$$ con $(u,v)\in\mathbb{R}\times[0,2\pi).$ <br/><br/>
* La parametrización de un toroide es $$t(u,v)=((2+\cos(v))\cos(u),(2+\cos(v))\sin(u),\sin(v))$$ con $(u,v)\in[0,2\pi)\times[0,2\pi).$ <br/><br/>
* La parametrización de una esfera es $$s(u,v)=(\cos(u)\cos(v),\cos(u)\sin(v),\sin(u)$$ con $(u,v)\in[0,2\pi)\times[0,\pi].$ <br/><br/>
...
* Si los vectores $\mathbf{u}=(1,2,3)$ y $\mathbf{v}=(2,1,3),$ calcule los $2\mathbf{u},\, 5\mathbf{u}-1/2\mathbf{v}$ y $\mathbf{u}+2\mathbf{v}-2\mathbf{u}. <br/><br/>
