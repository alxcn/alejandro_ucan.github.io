...
---
> <span style="font-size:35px"> Por ejemplo: $S_1=\{1,2,3,4,5\}.$  ¿ $3 \,\,\,\,S_1$ ?
<br/> <br/>
> <span style="font-size:35px"> Por ejemplo: $S_2=\{p  \in \mathbb{Z}: p \mbox{ es negativo}.\}$ y $20\,\,\,\, S_2.$

- $p\in \mathbb{Z}$ nos está delimitando donde vamos a encontrar nuestros elementos, y $p$ se le conoce como variable.
...
$$ A\cup C= \{1,2,4,9,10,16\}.$$
<br/> <br/>
> La _intersección_ de $A$ y $B$ es un núevo conjunto, denotado $A\cap B,$ que consta de los elementos que están en $A$ y $B$ (al mismo tiempo).
