...
> <span style="font-size:30px"> El rango de una función es el subconjunto del codominio que consiste en todos los posibles valores que se puedan obtener para cada elemento de $D.$
 ...
 $$ Im(f)=\left\{f(x)\in Y: x\in D\right\} $$
...
<br/>
* <span style="font-size:30px"> __Dominio:__
<br/><br/><br/>
* .pull-left[<span style="font-size:30px"> __Codominio:__]
.pull-right[<span style="font-size:30px"> __Rango:__]
