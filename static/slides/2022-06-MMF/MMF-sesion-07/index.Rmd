...
$$\mathbf{F} = \mathbf{e}_2\int_{x_0}^x B_z(x,y,z)dx + \mathbf{e}_3\left[\int_{y_0}^y B_y(x_0,y,z)dy -\int_{x_0}^x B_y(x,y,z)dx\right].$$ <br/><br/>

$$\mathbf{F} = -\mathbf{e}_1\int_{y_0}^y B_z(x,y,z)dy - \mathbf{e}_3\left[\int_{x_0}^x B_y(x,y_0,z)dx -\int_{y_0}^y B_y(x,y,z)dy\right].$$
...
$\displaystyle{\mathbf{F}_1= \mathbf{e}_2\int_{0}^x B_z dx = B_z x\mathbf{e}_2}.$

<br/>
$\displaystyle{\mathbf{F}_2= -\mathbf{e}_1\int_{0}^x B_z dx = -B_z y\mathbf{e}_1}.$

<br/>

> En general, en los libros de texto, el campo asociado es descrito como $$\mathbf{F}=\frac{B_z}{2}(x\mathbf{e}_2-y\mathbf{e}_1).$$
