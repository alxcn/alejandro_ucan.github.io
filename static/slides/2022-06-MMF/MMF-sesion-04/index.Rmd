...
> __Teorema:__ Si $\nabla f(\mathbf{x}_0)\neq \mathbf{0},$ entonces $\nabla f(\mathbf{x}_0)$ es la dirección donde la función crece más rapidamente.
...
![Gas Speed](/users/koyomi/Documents/Github/alejandro_ucan.github.io/static/slides/2022-06-MMF/MMF-sesion-04/Gas-speed.png)
---
# Divergencia:
...
<br/><br/>
__Ejemplo:__ Calcule el rotacional para las siguientes campos vectoriales: $\mathbf{F}_1(x,y)=(x,0),\, \mathbf{F}_2(x,y)=(x,y)$ y $\mathbf{F}_3=(-x,-y).$
...
Calcule el producto cruz  de los vectores $(1,2)$ y $(2,3),$ y los vectores $(1,2,-3)$ y $(-1,4,2).$
...
Imaginemos que tenemos el campo vectorial $\mathbf{F}(x,y,z)=(y,-x,0),$ que representa las velocidades de un fluído. 
...
![Gas Speed](/users/koyomi/Documents/Github/alejandro_ucan.github.io/static/slides/2022-06-MMF/MMF-sesion-04/fluid-speed.png)
---
# Interpretación física del Rotacional

En una sección de altura, esto se ve cómo:
...
pl.show()
```
![Gas Speed](/users/koyomi/Documents/Github/alejandro_ucan.github.io/static/slides/2022-06-MMF/MMF-sesion-04/transversal-fluid-speed.png)
