...
> Notemos que $\overline{\varepsilon_n(t)}=\varepsilon_{-n}(t),$ por lo que el polinomio trigonométrico es simplemente: $$p(t)=a_0+\sum_{j=1}^n\left(a_n cos\left(\frac{2\pi nt}{a}\right)+b_n\sin\left(\frac{2\pi n t}{a}\right)\right)$$
...
> Consideremos la función $f(t)=3t$ para $-1\leq t <1$ y $f(t+2)=f(t).$ Calcule los coeficientes en $T_N.$